...
namespace DCO_Player
{
    ...
    public partial class Start : Window
    {
        ...
        public Start()
        {
            ...
            login = new Log_In();                       // Инициализируем страницу Входа
            signup = new Sign_Up();                     // Инициализируем страницу Регистрации
            Frame.NavigationService.Navigate(login);    // Загружаем Вход по дефолту
        ...
        {
            LILine.Visibility = Visibility.Collapsed;
            SULine.Visibility = Visibility.Visible;
            Frame.NavigationService.Navigate(signup);

        }

        private void Log_In_MouseDown(object sender, MouseButtonEventArgs e)
        {
            LILine.Visibility = Visibility.Visible;
            SULine.Visibility = Visibility.Collapsed;
